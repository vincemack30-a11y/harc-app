 ...
 * - Always shows ALL coolers (including zero activity) using COOLERS registry
 */
...
export default function Manager() {
  ...
  // Orders/Help/Restock (light placeholders so the screen doesn't break)
  ...
  const loadOperational = async () => {
    try {
      ...
      // Restock requests (if table exists)
  ...
  // Build “complete” cooler maps so zero coolers always show
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, opacity: 0.75 }}>
                cooler_id is canonical • all analytics grouped by cooler_id
              </div>
            </div>
          </div>
        ...
        {tab === "analytics" ? (
          <div style={{ marginTop: 14 }}>
            ...
            >
              ...
              <Card title="Total Intake Requests" value={fmtInt(totals.intakes)} />
            </div>
