...
export default function ManagerAnalytics() {
  ...
  function exportOneCsv() {
    ...
    const coolerAddressById = new Map(COOLERS.map((c) => [c.cooler_id, c.address]));

    // One unified schema for the CSV
    const headers = [
      "record_type",
    ...
    for (const c of perCooler) {
      rows.push({
        ...
        revenue: safeNumber(c.revenue).toFixed(2),
    ...
    // Add a totals line (useful in spreadsheets)
    rows.push({
      record_type: "summary_total",
      cooler_id: "",
      cooler_name: "ALL COOLERS (TOTAL)",
      cooler_address: "",
      ...
      revenue: safeNumber(totals.revenue).toFixed(2),
      intake_requests: totals.intake,
    ...
    for (const o of filtered.orders || []) {
      ...
      rows.push({
        ...
        cooler_address: coolerAddressById.get(coolerId) || "",
    ...
    downloadTextFile(`harc_analytics_export_${rangeKey}_${stampKey}.csv`, csv);
  }
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <button
              ...
              title={loading ? "Wait for data to load" : "Download one combined CSV export"}
            >
              Export CSV
            </button>
